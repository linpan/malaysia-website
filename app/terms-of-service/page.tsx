        ...
        <Card className="p-6 md:p-8">
          <div className="space-y-8">
            <TermsSection title="1. Introduction">
              <p>
                Welcome to TalentPioneer. By accessing our website and using our services,
            ...
            <TermsSection title="2. Service Description">
              <p>
                TalentPioneer provides recruitment and talent acquisition services,
                connecting job seekers with potential employers. Our services include:
              </p>
            ...
            <TermsSection title="4. Professional Services">
              <p>
                Our professional services are provided on an "as is" basis. We strive to:
              </p>
              <ul className="list-disc ml-6 mt-2 space-y-2">
            ...
            <TermsSection title="5. Data Protection">
              <p>
                ...
                applicable data protection laws. Our data protection measures include:
              </p>
              <ul className="list-disc ml-6 mt-2 space-y-2">
            ...
            <TermsSection title="6. Intellectual Property">
              <p>
                All content, features, and functionality of our website are owned by
                TalentPioneer and are protected by international copyright, trademark,
            ...
            <TermsSection title="7. Modifications">
              <p>
                ...
                our services after such modifications constitutes acceptance of the new
                terms.
              </p>
            </TermsSection>
